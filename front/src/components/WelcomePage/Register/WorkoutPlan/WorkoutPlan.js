            ...
            <div className="workout-plan register-tap">
                ...
                <div className='days'>
                    ...
                    {!this.state.day1rest ?  <p>
                        ...
                        <input type="text" id="day1" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day2rest ?  <p>
                        ...
                        <input type="text" id="day2" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day3rest ?  <p>
                        ...
                        <input type="text" id="day3" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day4rest ?  <p>
                        ...
                        <input type="text" id="day4" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day5rest ?  <p>
                        ...
                        <input type="text" id="day5" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day6rest ?  <p>
                        ...
                        <input type="text" id="day6" className="login-input" onChange={this.props.saveInputValue} />
                    ...
                    {!this.state.day7rest ?  <p>
                        ...
                        <input type="text" id="day7" className="login-input" onChange={this.props.saveInputValue} />
